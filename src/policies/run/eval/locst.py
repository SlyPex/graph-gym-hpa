...
class UserBehavior(TaskSet):
    ...
    tasks = {index: 1, setCurrency: 2, browseProduct: 10, addToCart: 2, viewCart: 3, checkout: 1}
    ...
    for stat in stats.get_current().entries.values():
        for dep, rep in replicas.items():
            row = {
                ...
                "load_users": WebsiteUser.user_count if hasattr(WebsiteUser, "user_count") else "",
